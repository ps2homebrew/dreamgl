...
extern void		gs_wait_vsync(void);
extern void		gs_wait_hsync(void);
...
//---------------------------------------------------------------------------
// CLAMP Register - not complete
//---------------------------------------------------------------------------
#define WRAP_REPEAT		0
#define WRAP_CLAMP		1

#define GS_CLAMP(WMS,WMT) \
	(((uint64)(WMS)	<< 0)	| \
	 ((uint64)(WMT)	<< 2))
...
//---------------------------------------------------------------------------
// PRMODE Register - Setup Current Primitive Drawing Mode
//---------------------------------------------------------------------------
#define SHADE_FLAT		0
...
//   MXL  - Maximum MipMap Level (0-6)
//   MMAG - Filter for when texture is expanded
//   MMIN - Filter for when texture is reduced
//   MTBA - MipMap >= Level 1 Address Specification
//   L    - LOD Parameter L
//   K    - LOD Parameter K
//---------------------------------------------------------------------------
